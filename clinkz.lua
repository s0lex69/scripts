...
clinkz.optionEnablePoopLinkens = Menu.AddOptionBool({"Hero Specific", "Clinkz"}, "Poop Linken", false)
clinkz.optionEnablePoopForce = Menu.AddOptionBool({"Hero Specific", "Clinkz", "Poop Linkens Items"}, "Force Staff", false)
clinkz.optionEnablePoopBlood = Menu.AddOptionBool({"Hero Specific", "Clinkz", "Poop Linkens Items"}, "Bloodthorn", false)
clinkz.optionEnablePoopOrchid = Menu.AddOptionBool({"Hero Specific", "Clinkz", "Poop Linkens Items"}, "Orchid", false)
clinkz.optionEnablePoopEul = Menu.AddOptionBool({"Hero Specific", "Clinkz", "Poop Linkens Items"}, "Eul", false)
clinkz.optionEnablePoopHex = Menu.AddOptionBool({"Hero Specific", "Clinkz", "Poop Linkens Items"}, "Hex", false)
clinkz.optionEnablePoopPike = Menu.AddOptionBool({"Hero Specific", "Clinkz", "Poop Linkens Items"}, "Hurricane Pike", false)
LockTarget = false
enemy = nil
