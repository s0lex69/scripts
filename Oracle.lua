...
--Items Toggle Menu--
Oracle.optionEnableBottle = Menu.AddOptionBool({"Hero Specific","Oracle","Items"},"Use Bottle on Target During Ult",false)
Oracle.optionEnableGreaves = Menu.AddOptionBool({"Hero Specific","Oracle","Items"},"Use Greaves on Target During Ult",false)
Oracle.optionEnableMekansm = Menu.AddOptionBool({"Hero Specific","Oracle","Items"},"Use Mekansm on Target During Ult",false)
Oracle.optionEnableSalve = Menu.AddOptionBool({"Hero Specific","Oracle","Items"},"Use Salve on Target During Ult",false)
Oracle.optionEnableUrn = Menu.AddOptionBool({"Hero Specific","Oracle","Items"},"Use Urn on Target During Ult",false)
Oracle.optionEnableVessel = Menu.AddOptionBool({"Hero Specific","Oracle","Items"},"Use Vessel on Target During Ult",false)
...
function Oracle.IsSuitableToCastSpell(myHero)
...
function Oracle.CanCastSpellOn(npc)
