...
LegionCommander.optionEnablePoopPike = Menu.AddOptionBool({"Hero Specific", "Legion Commander", "Poop Linken Items"}, "Hurricane Pike", false)
LegionCommander.optionEnablePoopDagon = Menu.AddOptionBool({"Hero Specific", "Legion Commander", "Poop Linken Items"}, "Dagon", false)
LegionCommander.optionEnablePoopOrchid = Menu.AddOptionBool({"Hero Specific", "Legion Commander", "Poop Linken Items"}, "Orchid", false)
